...
if [[ ! -f "$LIB_JSON" ]]; then
  echo "Error: json-fortran not found in pixi environment."
  echo "Make sure 'json-fortran' is listed under [dependencies] in pixi.toml."
  exit 1
fi
...
set +x # That'll do for CI debugging
